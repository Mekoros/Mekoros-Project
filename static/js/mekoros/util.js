...
class Util {
    ...
    static localeDate(dateString) {
        ...
        const locale = Mekoros.interfaceLang === 'english' ? 'en-US' : 'he-Hebr-IL';
    ...
    static hebrewCalendarDateStr(dateObjStr){
        ...
        return Mekoros.interfaceLang === 'english' ? hd.render() : hd.renderGematriya();
    }
    ...
    static naturalTime(timeStamp, {lang, short}={}) {
      ...
      let language = lang ? lang : (Mekoros.interfaceLang === 'hebrew' ? 'he' : 'en');
      let spacer = " ";
      if(short){
          language = language == "en" ? "shortEn" : "shortHe";
          spacer = language == "shortEn" ? "" : " ";
      }
      return Util.mekorosHumanizeDuration(now - timeStamp, { "language": language, "spacer": spacer });
    }
    ...
    static RefValidator($input, $msg, $ok, $preview, options = {}) {
         ...
         * example usage:
         ...
         new Mekoros.util.RefValidator($("#inlineAdd"), $("#inlineAddDialogTitle"), $("#inlineAddSourceOK"), $("#preview"));
        ...
        this.$input
            ...
            .autocomplete({
                source: function(request, response) {
                  Mekoros.getName(request.term, true)
...
Util.RefValidator.prototype = {
  ...
  _lookupAndRoute: function(inString) {
      ...
      this.current_lookup_ajax = Mekoros.makeCancelable(Mekoros.getName(inString, true));
      this.current_lookup_ajax.promise.then(data => {
              ...
              if (Mekoros.isACaseVariant(inString, data)) {
                this._lookupAndRoute(Mekoros.repairCaseVariant(inString, data));
                this.current_lookup_ajax = null;
                return;
              }
  ...
  _inlineAddSourcePreview: function(inString, ref) {
    Mekoros.text(ref, {}, function (data) {
...
Util.mekorosHumanizeDuration = humanizeDuration.humanizer({
