const Strings = {
  _i18nInterfaceStrings: {
    ...
    "Community": "קהילה",
    "Donate": "תרומה",
    "Mekoros Notifications": "הודעות בספריא",
    "Mekoros: a Living Library of Jewish Texts Online": "ספריא: ספריה יהודית דינמית",
    "Recently Viewed" : "נצפו לאחרונה",
    "The Mekoros Library": "תוכן העניינים של ספריא",
    "Mekoros Search": "חיפוש בספריא",
    "Mekoros Account": "חשבון בספריא",
    "Notifcations": "התראות",
    "New Additions to the Mekoros Library": "חידושים בארון הספרים של ספריא",
    "My Notes on Mekoros": "ההערות שלי בספריא",
    "Texts & Source Sheets from Torah, Talmud and Mekoros's library of Jewish sources.": "טקסטים ודפי מקורות מן התורה, התלמוד וספריית המקורות של ספריא.",
    ...
    "Teach with Mekoros": "מלמדים עם ספריא",
    ...
    "Mekoros mobile app.": "אפליקציית ספריא לנייד.",
    ...
    "Support Mekoros": "תמכו בספריא",
    "Mekoros is an open source, nonprofit project. Support us by making a tax-deductible donation.": "ספריא היא מאגר פתוח וחינמי. תמכו בנו בעזרת תרומה.",
    "Make a Donation": "לתרומה",
    "Join the Conversation": "קחו חלק בשיח" ,
    "Explore the Community": "לעמוד הקהילה",
    "People around the world use Mekoros to create and share Torah resources. You're invited to add your voice.": "לומדים ולומדות מכל רחבי העולם משתמשים בספריא כדי ליצור ולשתף מקורות יהודיים. אנו מזמינים אתכם לקחת חלק בשיח זה.",
    "Create with Mekoros": "צרו בעזרת ספריא",
    ...
    "With your help, we can add more texts and translations to the library, develop new tools for learning, and keep Mekoros accessible for Torah study anytime, anywhere.": "בעזרת התרומה שלכם נוכל להוסיף מקורות, תרגומים, לפתח כלים חדשים ללימוד ולשמור על גישה חופשית ללימוד תורה, בכל מקום ובכל זמן.",
    ...
    // Community Page
    "From the Community: Today on Mekoros": "מן הקהילה: היום בספריא",
    "Today on Mekoros": "היום בספריא",
    ...
    "published": "פורסם",
    "on Mekoros and visible to others through search and topics.": ".בספריא ומשתמשים אחרים יכולים למצוא אותו בחיפוש ובדפי הנושא",
    "List your sheet on Mekoros for others to discover.": ".רישום דף המקורות שלך בספריא באופן שמשתמשים אחרים יוכלו למצוא אותו",
    ...
    "Publish your sheet on Mekoros for others to discover.": "פרסמו את דף המקורות בספריא כדי שאחרים יוכלו ללמוד ממנו.",
    ...
    "Unlisted": "חסוי",
    "History": "היסטוריה",
    "Digitized by Mekoros": 'הונגש ועובד לצורה דיגיטלית על ידי ספריא',
    ...
    "Collection": "אסופה",
    "Collections of sheets are created by Mekoros users and can be privately, shared with friends, or made public on Mekoros.": "אסופות הן מקבצים של דפי מקורות שנוצרו על ידי משתמשי האתר. הן ניתנות לשימוש פרטי, לצורך שיתוף עם אחרים או לשימוש ציבורי באתר ספריא.",
    "Mekoros Collections": "אסופות של ספריא",
    ...
    "You can use collections to organize your sheets or public sheets you like. Collections can be shared privately or made public on Mekoros.": "באפשרותך ליצור אסופות כדי לארגן את דפי המקורות שלך או דפי מקורות פתוחים לשימוש שאהבת. את האסופות אפשר לשתף באופן פרטי או לפרסם באופן ציבורי באתר ספריא.",
    ...
    "List on Mekoros": "הצג לכלל משתמשי ספריא",
    ...
    "Sign up to get more from Mekoros" : "הרשמו כדי לקבל יותר מספריא",
    ...
    "All History": "כל ההסטוריה",
     ...
     //About
    "What is Mekoros?": "מהי ספריא",
    "Team": "צוות ספריא",
    "Jobs at Mekoros": "משרות פנויות בספריא",
    ...
    "Average Mekoros User" : "משתמש ממוצע בספריא",
    "Etc": "שאר",
    ...
    "Thank you for trying the new Mekoros editor! We’d love to hear what you thought. Please take a few minutes to give us feedback on your experience.": "תודה שניסית את עורך ספריא החדש! נשמח מאוד לשמוע את דעתך עליו. אנו מבקשים ממך להקדיש כמה דקות למילוי משוב על חוויית השימוש שלך.",
    ...
    "Thank you!": "תודה רבה!",
    "You are currently testing the new Mekoros editor.": "ברגע זה הינך עושה שימוש בעורך החדש של ספריא",
    "You are currently using the old Mekoros editor.": "כעת הינך עושה שימוש בגרסה הישנה של עורך ספריא",
    ...
    "Works on Mekoros": "חיבורים וכתבים בספריא",
