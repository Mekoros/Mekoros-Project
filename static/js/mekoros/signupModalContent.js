...
const signUpModalContent = {
  [SignUpModalKind.ViewHistory]: {
    ...
    h3: {
      en: "Create a free account to do more on Mekoros",
  ...
  [SignUpModalKind.AddTranslation]: {
    ...
    h3: {
      en: "Create a free account to add it to the library & do more on Mekoros",
  ...
  [SignUpModalKind.Follow]: {
    h2: {
      en: "Want to connect with other Mekoros users?",
  ...
  [SignUpModalKind.Default]: {
    ...
    h3: {
      en: "Sign up to get more from Mekoros",
