...
import palette from './mekoros/palette';
...
const ContestLandingPage = () => (
    <StaticPage>
        <Header
            enTitle="Powered by Mekoros Contest"
        ...
        <EnBlock padded={true}>
            <p>Mekoros offers a free digital dataset of Jewish texts, translations, and interconnections that is open for anyone to reuse in novel ways. Last year, we received over 50 innovative Powered by Mekoros projects using our open data or API (<a href="/powered-by-mekoros-contest-2020">see the winners and honorable mentions!</a>). We’re eager to see what else our community can dream up to advance the frontiers of Torah and technology in this year’s contest!</p>
            ...
            <p>To get your ideas flowing, here are three great examples from last year’s Powered by Mekoros contest. You can find dozens more projects on our <a href="https://github.com/Mekoros/Mekoros-Project/wiki/Projects-Powered-by-Mekoros">Powered by Mekoros list</a> on GitHub and on the <a href="https://www.mekoros.com/powered-by-mekoros-contest-2020">Powered by Mekoros 2020 Winners & Honorable Mentions page</a>.</p>
        </EnBlock>
        <HeBlock padded={true}>
            <p>ספריא מציעה לציבור מסד נתונים דיגיטלי וחופשי של מקורות יהודיים, תרגומים וקישורים בין־טקסטואליים.  בשנה שעברה הגיעו לפתחנו יותר מ־50 מיזמים חדשניים שהשתמשו במסד הנתונים הפתוח  או ב־API שלנו (<a href="/powered-by-mekoros-contest-2020">ראו את המיזמים הזוכים ואת המיזמים שזכו להערכה מיוחדת</a>). אנו מלאי ציפייה לראות מה עוד מסוגלת הקהילה שלנו לעשות כדי לחצות את הגבולות המוכרים של התורה והטכנולוגיה?</p>
        ...
        <GreyBox>
            <ImageWithText
                enText="<i>“By open-sourcing a vast array of Jewish texts, Mekoros's API makes programmatic analysis of Jewish tradition simple for the everyday programmer. talmud.page began as my own hand-tailored UI for learning Daf Yomi. The more developers use Mekoros's API to solve creative questions, the richer Jewish learning will be worldwide.”
                    <br/><br/>
        ...
        <EnBlock padded={true}>
            <p>Interested in participating in the contest? <a href="#">Sign up</a> for updates and resources, including office hours with the Mekoros engineering team. We'll share a link for project submissions with you in the coming weeks!</p>
        </EnBlock>
        <HeBlock padded={true}>
        ...
        <ButtonRow white={true}>
            ...
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="https://github.com/Mekoros/Mekoros-Project"
                he_href="https://github.com/Mekoros/Mekoros-Project"
                he="GitHub"
                en="GitHub"
            />
        </ButtonRow>
        ...
        <CallToActionFooterWithButton
            href="/powered-by-mekoros-contest-2020"
            he_href="/powered-by-mekoros-contest-2020"
...
const RambanLandingPage = () => {
    ...
    return <StaticPage optionalClass="englishOnly">
        ...
        <ResponsiveNBox content={
            ...
            ['Lech Lecha', 'Rabbi David Aladjem', 'In support of Mekoros', '/Genesis.12.1?with=Ramban'],
        ...
        <ResponsiveNBox content={
            ...
            ['Chukat', 'Kevin Waldman', 'In support of Mekoros', '/Numbers.19.1?with=Ramban'],
        ...
        <ResponsiveNBox content={
            ...
            ['Vaetchanan', 'Becky and Avi Katz', 'In honor of Mekoros', '/Deuteronomy.3.23?with=Ramban'],
...
const SheetsLandingPage = () => (
    <StaticPage>
        <Header
            enTitle="Create with Mekoros"
            enText="Mix and match sources from Mekoros’s library of Jewish texts, and add your comments, images and videos."
            enImg="/static/img/sheets-landing-page/sheetspage_headerimage.png"
            enImgAlt="Mekoros Sheets"
            enActionURL="/sheets/new?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
            ...
            heImgAlt="דפי מקורות"
            heActionURL="/sheets/new?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
        ...
        <EnBlock>
            <Section>
                <Sheet
                    ...
                    link="/sheets/17566?lang=bi&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
                ...
                <Sheet
                    ...
                    link="/sheets/184685?lang=bi&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
                    author="Olivia Friedman"
                    image="/static/img/sheets-landing-page/olivia.png"
                />
                <Sheet
                    title="Practical Torah for Time Management"
                    link="/sheets/193023?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
                ...
                <Sheet
                    ...
                    link="/sheets/9219?lang=bi&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
        ...
        <HeBlock>
            <Section>
                <Sheet
                    title="תפילת הדרך"
                    link="/sheets/216261?lang=he&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
                    author="אתר מדרשת"
                    image="/static/img/sheets-landing-page/midreshet.png"
                />
                <Sheet
                    title="כיצד למד הבעל שם טוב את התורה?"
                    link="/sheets/112651?lang=he&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
                ...
                <Sheet
                    ...
                    link="/sheets/222661?lang=he&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
                    author="חדוה יחיאלי"
                    image="/static/img/sheets-landing-page/hedva.png"
                />
                <Sheet
                    title="מעשה ברבי ישמעאל"
                    link="/sheets/141399?lang=he&utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
        ...
        <Section>
            <SimpleButton
                ...
                href="/topics?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
                he_href="/topics?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
            />
        </Section>
        <Spacer />
        <CallToActionFooterWithButton
            href="/sheets/228095?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets"
            he_href="/sheets/226003?utm_source=Mekoros&utm_medium=LandingPage&utm_campaign=Sheets_HEB"
...
const RemoteLearningPage = () => (
    <StaticPage>
        <Header
            ...
            enText="Discover the power of online education. Mekoros is always available to provide foundational Jewish texts, educational materials, and the tools to allow you to engage with dynamic Jewish learning."
            enImg="/static/img/distance-learning-landing-page/remotelearning_headerimage.png"
            enImgAlt="Mekoros on tablet."
            enActionURL={null}
            enActionText={null}
        ...
        <GreyBox>
            <ButtonRow enTitle="Browse our Latest Resources" heTitle="מקורות בספריא">
                <SimpleButton
                    ...
                    rounded={false}
                    tall={true}
                    href="/collections/educator-newsletters?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                    he_href="/sheets/219410?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                ...
                <SimpleButton
                    ...
                    rounded={false}
                    tall={true}
                    href="/sheets/227733?lang=bi?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                    he_href="/sheets/227981.5?lang=he&utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                    he="נגיף הקורונה"
                ...
                <SimpleButton
                    ...
                    rounded={false}
                    tall={true}
                    href="/collections/KGvMhYW3#?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                    he_href="/collections/KGvMhYW3?lang=he&utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
        ...
        <Feature
            enTitle="Learners"
            enText="Whether you’re a pro, or a new user, Mekoros has resources to help your virtual study thrive. Join a Mekoros 101 webinar, browse our tutorials, or sign up for the online student training course to up your skills on all things Mekoros. <a href='/register?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning'>Create a free account</a> to track your learning, save texts, and follow users creating things that interest you."
            ...
            heText={
                ...
                + "<a href='/register?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning'>"
                + "צרו חשבון משתמש"
                + "</a>"
        ...
        <ButtonRow light={true}>
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="/collections/webinars-for-learners?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/224909?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he="וובינרים"
            ...
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="/collections/mekoros-faqs?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/224919?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
            ...
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="/collections/mekoros-student-course?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/228260?lang=he&utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he="הסודות של ספריא"
                en="Student Course"
            />
        </ButtonRow>
        <Feature
            ...
            enText="Mekoros is here to support your online teaching. Our <a href='/educators?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning'>Learning Department</a> has a variety of resources to get you started with distance learning using Mekoros. <a href='/register?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning'>Create a free account</a> to make and assign source sheets to your students, organize your sheets into groups, and save texts."
            enImg="/static/img/distance-learning-landing-page/remotelearningpage_educators.png"
            enImgAlt="Source Sheet - Teaching with Mekoros Online"
        ...
        <ButtonRow light={true}>
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="/collections/webinars-for-educators?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/224909?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he="וובינרים"
            ...
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="/collections/tutorials-for-educators?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/224923?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
            ...
            <SimpleButton
                ...
                rounded={false}
                tall={true}
                href="https://mekoros.typeform.com/to/tJVexqpG?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
                he_href="/sheets/223245?lang=he?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning"
        ...
        <Feature
            ...
            enText="Is it time to start incorporating digital texts into your website, blog, or app? Mekoros has you covered. All of our software is open source and our texts are all in the creative commons – meaning you can use anything we have for your own projects. Take a look at these resources and get in touch with your web/app developer to start including Mekoros’s texts on your site."
            enImg="/static/img/distance-learning-landing-page/remotelearningpage_developers.png"
            enImgAlt="Source Sheet - Link Mekoros to your Site"
        ...
        />
        <ButtonRow light={true}>
            <SimpleButton white={true} tall={true} rounded={false} href="/linker?utm_source=mekoros&utm_medium=landingpage&utm_campaign=remotelearning" he="לינקר דו צדדי" en="Two-Way Linker"/>
            <SimpleButton white={true} tall={true} rounded={false} href="https://github.com/Mekoros/Mekoros-Project/wiki/Projects-Powered-by-Mekoros" he="אתרים המופעלים ע”י ספריא" en="Powered by Mekoros"/>
            <SimpleButton white={true} tall={true} rounded={false} href="https://github.com/Mekoros/Mekoros-Project/wiki#developers" he="Github גיטהאב" en="GitHub"/>
        </ButtonRow>
...
const EducatorsPage = () => (
  <StaticPage>
    ...
    <GreyBox>
      ...
      <EnBlock padded={true}>
        <p>Empower your students with Mekoros’s free library of digital texts, in Hebrew and English translation, and use our teaching materials to spark creativity and foster independence. Learn new ways of teaching and engaging your students in the centuries-old conversation around Jewish texts, and join Mekoros’s Educator community.</p>
      </EnBlock>
      <HeBlock padded={true}>
    ...
    <Feature
      ...
      enText="Whether you’re a pro or a new user, Mekoros has resources to help you and your students learn and thrive. Join a Mekoros webinar, browse our tutorials, sign up for our Educator course, or request a custom workshop for your team or your students."
      enImg="/static/img/educators-landing-page/teaching-with-mekoros-library.png"
      ...
      heImg="/static/img/educators-landing-page/teaching-with-mekoros-library-heb.png"
    ...
    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Online Educator Course", "מדריך למשתמש בספריא", "https://mekoros.typeform.com/to/tJVexqpG", "https://www.mekoros.com/sheets/361600?lang=he"],
          ["Lesson Plans on Mekoros", "ספריא לתלמידים", "/collections/pedagogy-on-mekoros-exemplary-lesson-plans", "https://www.mekoros.com/collections/KGMlHrvA"],
          ["Schedule A Workshop", "שאלות נפוצות", "https://mekoros.typeform.com/to/Pl3biam8", "https://www.mekoros.com/collections/%D7%A9%D7%90%D7%9C%D7%95%D7%AA-%D7%A0%D7%A4%D7%95%D7%A6%D7%95%D7%AA-%D7%91%D7%A1%D7%A4%D7%A8%D7%99%D7%90"]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
    ...
    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Past Educator Newsletters", "10 רעיונות להערכה חלופית", "/collections/qZ0UWi5y", "https://www.mekoros.com/sheets/281661?lang=he"],
          ["Mekoros in Action", "עבודת חקר: מסע בין מקורות", "/sheets/311116?lang=bi", "https://www.mekoros.com/collections/%D7%A2%D7%91%D7%95%D7%93%D7%AA-%D7%97%D7%A7%D7%A8-%D7%91%D7%A1%D7%A4%D7%A8%D7%99%D7%90-%D7%9E%D7%A1%D7%A2-%D7%91%D7%99%D7%9F-%D7%9E%D7%A7%D7%95%D7%A8%D7%95%D7%AA"],
          ["For Your Students", "מערכי שיעור", "/sheets/311291?lang=bi", "https://www.mekoros.com/sheets/361593?lang=he"]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
    ...
    <Feature
      enTitle="Mekoros for Educators How-Tos"
      enText="Browse our FAQ’s and learn more about how to use Mekoros’s tools to study and to teach. Mekoros’s Learning Team is always available to support you and your students or answer any questions you might have. If there are texts, translations, lesson plans, or student materials that would enhance your teaching, please share that with us as well."
      enImg="/static/img/educators-landing-page/tutorials-for-educators.png"
      enImgAlt="Mekoros for Educators How-Tos"
    ...
    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Educator FAQ", "אסופות מומלצות", "/collections/tutorials-for-educators","https://www.mekoros.com/sheets/360599?lang=he"],
          ["Request New Resources", "עמוד הקהילה", "https://mekoros.typeform.com/to/aaZmi4JD","https://www.mekoros.com/community"],
          ["Webinars for Educators", "הסודות של ספריא", "/collections/qJLU68HQ","https://www.mekoros.com/sheets/228260.2?lang=he"]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
    ...
    <GreyBox>
      ...
      <EnBlock padded={true}>
          <p>Was your teaching enhanced by Mekoros? Did you have a “Mekoros moment” with your students? Share it with us! We love to hear how educators are using Mekoros in the field and we learn from the feedback we receive. We are also available to answer all of your Mekoros questions. Write to us at education@mekoros.com.</p>
      </EnBlock>
      <HeBlock padded={true}>
          ...
          <p>כתבו לנו לכתובת המייל hello@mekoros.com</p>
    ...
    <Section>
      <UserQuote
          heText=""
          enText="As an educator, I have come to appreciate Mekoros more and more. I now make sure to expose all of my students to what Mekoros has to offer. I show them how to use Mekoros to make source sheets. <b>I love hearing their excitement as they realize how easy it is to make a sheet on Mekoros and how organized their final products look.</b> They also are impressed at how Mekoros helps them do research by finding sources that connect to their topic. I am grateful that Mekoros is there to provide Torah resources to my students after they complete their formal Jewish education. Overall, the experience of using Mekoros with my students has been very positive!"
      ...
      />
      <UserQuote
          enText="I really appreciate Mekoros. I use it all the time studying for tests, doing homework, doing learning on my own or even preparing for a seminary interview. <b>The fact that I can quickly and easily find whatever I need wherever I am and understand and study it is incredible.</b> I'm so so grateful for Mekoros. I've introduced all my friends to it and they all use it now too."
          heText=""
      ...
      />
      <UserQuote
        enText="Students have exposure to so many more commentaries than they would have in the past because of Mekoros and online texts. What I like most about Mekoros is the ability to compare and contrast texts clearly with the text side by side. It is a very powerful tool in the classroom and allows students to be more active in the learning process. Mekoros has also enhanced the level of sophistication of student project based learning."
        heText=""
...
const RabbisPage = () => (
  <StaticPage>
    ...
    <GreyBox>
      ...
      <EnBlock padded={true}>
        <p>Engage your community in learning using Mekoros’s free library of digital texts, in Hebrew and English translation. Enjoy having an extensive library at your fingertips for learning in the synagogue, on campus, at home or on the go. Share your Torah with Mekoros learners near and far.</p>
      </EnBlock>
      <Spacer/>
    </GreyBox>
    ...
    <Feature
      enTitle="Mekoros in Your Community"
      enText="Explore the ways in which Mekoros supports teaching and learning. Whether you’re a pro or a new user, Mekoros has resources to help you and your community learn and thrive. Request a custom workshop for your team or your community, discover how to use Chavruta for learning events, and share your Divrei Torah and Sermons using Collections."
      enImg="/static/img/rabbis-landing-page/sara+rabbis.jpg"
      enImgAlt="Mekoros in Your Community"
      borderColor={palette.colors.darkblue}
    />

    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Schedule A Workshop", "שאלות נפוצות", "https://www.mekoros.com/sheets/370615?lang=bi", "https://www.mekoros.com/collections/%D7%A9%D7%90%D7%9C%D7%95%D7%AA-%D7%A0%D7%A4%D7%95%D7%A6%D7%95%D7%AA-%D7%91%D7%A1%D7%A4%D7%A8%D7%99%D7%90"],
          ["Innovating with a Digital Library", "", "https://www.mekoros.com/sheets/415628?lang=bi", ""],
          ["Collections: A Home for Sermons and Classes", "", "https://www.mekoros.com/sheets/370836?lang=bi", ""]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
     ...
     <Feature
      ...
      enText="Stay up to date with the latest news and resources from Mekoros. Find relevant texts and sheets for thousands of topics, use and share Mekoros’s Chavruta feature for your own chavruta study, and get inspired to try something new in your work."
    ...
    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Past Rabbi Newsletters", "", "https://www.mekoros.com/collections/T-5hbqOq?tab=sheets", ""],
          ["Topics Tutorial", "", "https://www.mekoros.com/sheets/231377?lang=bi", ""],
          ["Studying With a Partner: A Chavruta Tutorial", "", "https://www.mekoros.com/sheets/263246?lang=bi", ""]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
    ...
    <Feature
      enTitle="Mekoros How-Tos"
      enText="Browse our Help Center and learn more about how to use Mekoros’s tools to study and to teach. Mekoros’s Learning Team is always available to support you or answer any questions you might have. If there are texts, translations, or learning materials that would enhance your work, please share that with us as well!"
      enImg="/static/img/rabbis-landing-page/help-center-screenshot.png"
      enImgAlt="Mekoros How-Tos"
      borderColor={palette.colors.red}
    />

    <ButtonRow white={true} enTitle="" heTitle="">
      { [
          ["Help Center", "", "https://www.mekoros.com/collections/mekoros-faqs",""],
          ["Webinars", "", "https://www.mekoros.com/sheets/228105?lang=bi",""],
          ["Request New Resources", "", "https://mekoros.typeform.com/to/aaZmi4JD?typeform-source=www.mekoros.com",""]
      ].map(i =>
          <SimpleButton
              white={true}
              rounded={false}
    ...
    <GreyBox>
      ...
      <EnBlock padded={true}>
          <p>Was your work enhanced by Mekoros? Did you have a “Mekoros moment” with your learning community? Share it with us! We love to hear how rabbis are using Mekoros in the field and we learn from the feedback we receive. We are also available to answer all of your Mekoros questions. Write to us at education@mekoros.com.</p>
      </EnBlock>
      <Spacer/>
    </GreyBox>
    ...
    <Section>
      <UserQuote
          heText=""
          enText="“Mekoros is a gift to those of us seeking not just the conclusions to Halakhic arguments, but the entirety of the conversation; we are the ones who look up every citation and want to fully grasp the web of discourse for ourselves and Mekoros makes that so easy. It is equally a gift to those of us who teach and know the importance of providing readable and easy to find sources for our students. I use Mekoros to create and share annotated source sheets with some of the more complicated sources we discuss and invite my students to iterate on those sheets in turn. Before applying to rabbinical school, I studied how Mekoros shaped students' experiences of learning. Now, I am lucky to study Torah with my students using Mekoros.”"
          enName="Rabbanit Dr. Liz Shayne"
          heName=""
          image="/static/img/rabbis-landing-page/lizshayne 1.png"
      />
      <UserQuote
          enText="“Mekoros’s commitment to digital text access for all who seek to take hold of Torah played a pivotal and unparalleled role in my rabbinical school journey. As a blind woman in the rabbinate, Mekoros’s digital library enabled me to access texts with ease for both educational and Torah lishma purposes. With much hakarat hatov do I thank Mekoros for the holy work you are doing.”"
          heText=""
      ...
      <UserQuote
        heText=""
        enText="“As a Rabbi, I have come to rely on Mekoros for my own lishmah study, as well as for creating source sheets for programs and study sessions in my community. I look forward to all that Mekoros still has in store for the Jewish world, and am proud to continue supporting your work.”"
        enName="Rabbi Max Chaiken | Temple Emanuel | Andover, MA"
        heName=""
        image="/static/img/rabbis-landing-page/Rabbi-Chaiken-Headshot.png"
      />
      <UserQuote
        enText="“Due to Hurricane Harvey in 2017 I lost about half of my library.  While some of the lost seforim have been replaced, I do not have the physical space to have access to them.  I have relied on the amazing Mekoros library to make up for the books that I am missing or cannot get to. I use Mekoros on a daily basis and there are some days that it is open on my computer all day long.  Mekoros and I spend extra time together on Friday when it is Drasha preparation time. I am grateful for the regular updates and additions Mekoros makes to the library.”"
        heText=""
...
const PBSC2020LandingPage = () => (
    <StaticPage>
        <Header
            enTitle="Powered by Mekoros Contest 2020"
        ...
        <Feature
            ...
            enText="By Dov Katz<br/><br/>The Talmud Sidebar Extension brings Mekoros’s learning resources to Daf Yomi sites across the web. Created in response to the move to Zoom for Daf Yomi classes the world over in the wake of COVID-19, the extension recognizes what daf you’re learning or listening to on nearly a dozen Daf Yomi sites. It then enables a sidebar to see connections from Mekoros’s library or link straight back to Mekoros."
        ...
        <GreyBox>
            ...
            <EnBlock padded={true}>
                <p>Mizmor Shir was created by three college students – Simon Landau, a junior at USC majoring in Computer Science; Immanuel Bissel, a rising sophomore at Yale majoring in Earth and Planetary Science; and Ben Kotton, also a rising Sophomore at Yale, majoring in applied mathematics. Friends from a childhood shared in Los Angeles, all three are avid music lovers – Simon plays both orchestral bass as well as guitar in a three-piece band, Emmanuel the guitar, and Ben the mandolin. It was this love that got them excited to respond to Mekoros’s PBS challenge with an idea that combined music with Torah and harnessed the power of technology to reveal the beauty of each in new ways.</p>
            </EnBlock>
            <HeBlock padded={true}>
        ...
        <Section>
            <UserQuote
                enText="It was very exciting to see all of the creative applications to the Powered by Mekoros Contest. There was such a wide range of ideas, truly displaying the power of Mekoros to engage a range of audiences. At the core of all of the ideas was creating innovative ways to allow more people to engage with text in a deeper way, from bringing the text to life through interactive museums to creating additional features and ease for the toolbar and the Mekoros browsing experience.<br/><br/>Many of the ideas are very promising and I hope the contestants continue to explore their ideas and bring their passion to life. Thanks to Mekoros for creating such an accessible and open platform to allow for such a meaningful and collaborative competition."
            ...
            />
            <UserQuote
                enText="I was incredibly impressed by the submissions to the Powered by Mekoros contest. When Mekoros started, we could not have imagined the level of technical talent that would be applied to enhancing Mekoros's texts and platform. The submissions to the contest were both interesting and often quite practical, many adding useful features on top of Mekoros's existing platform. I was especially excited to see such wonderful energy from our younger supporters who brought creativity and vision to the contest. Congratulations to all the submitters!"
                ...
                enName="Mo Koyfman, <i>Founder of early-stage venture capital firm, Shine Capital; founding Mekoros board member</i>"
        ...
        <Feature
            enTitle="Mekoros Space: (Topic Museum + Text Mania)"
            enText="By David Komer<br/><br/>The Mekoros Space has two parts: the Topic Museum creates an immersive 3D environment where you can explore texts related to a topic as though they were paintings hanging on a wall. Text Mania is a 3D game based on the letters of a text of your choosing."
            enImg="/static/img/pbsc-2020-landing-page/mekorosspace.png"
            enImgAlt="Mekoros Space: (Topic Museum + Text Mania)"
            ...
            heImg="/static/img/pbsc-2020-landing-page/mekorosspace.png"
            heImgAlt="מרחב ספריא (מוזיאון נושאי + טָרֶפֶת טקסט)"
            borderColor={palette.colors.darkpink}
            link=" https://mekoros-space.web.app/"
        />


        <Feature
            enTitle="The Rabbinic Citation Network"
            enText="By Michael Satlow and Mike Sperling<br/><br/>Using Mekoros's digital text of the Bavli, the Rabbinic Citation Networks extracts the names and links of rabbis who cite (or who are cited by) other rabbis and visualizes the resulting network."
        ...
        <Feature
            enTitle="mekoros-connections"
            enText="By Charles Loder<br/><br/>Mekoros-connections is an interactive visualization of the connections between texts in Mekoros’s library. Starting from any line of Tanakh you can choose a type of connection, see the sources that match that type, and see the sources connected to those sources."
            enImg="/static/img/pbsc-2020-landing-page/mekorosconnections.png"
            ...
            heImg="/static/img/pbsc-2020-landing-page/mekorosconnections.png"
            heImgAlt="קשרי ספריא"
            borderColor={palette.colors.tan}
            link="https://charlesloder.github.io/mekoros-connections/"
        />


        <Feature
            enTitle="SefariAcrostic"
            enText="By Ezra Gordon<br/><br/>MekorosAcrostic searches books of Tanakh for acrostics that match a person’s Hebrew name. Acrostics can be used to create digital art or to inspire personalized artwork for a simcha, such as finding an acrostic with the couple's names for a wedding."
            ...
            link="https://20gordone.github.io/MekorosContest/"
        />
        ...
        <ButtonRow white={true} enTitle="Explore more projects" heTitle="למידע על עוד כמה מיזמים">
            { [
                ...
                ["Visualizations of Mekoros", "", "https://guedalia.github.io/testab/test"],
...
const DonatePage = () => (
  <StaticPage optionalClass="donate">
    ...
    <div className="staticPageBlockInner flexContainer">
        ...
        <ResponsiveNBox gap="30px" content={[
            <FeatureBox
                ...
                heTitle=""
                enText="Whether you give $1.80, $18, or $1,800, every gift made to Mekoros supports the future of Torah."
                heText=""
                enButtonText="Donate Now"
                heButtonText=""
                enButtonUrl="https://donate.mekoros.com/"
                heButtonUrl="https://donate.mekoros.com/he"
                borderColor="#004E5F"
            />,
            <FeatureBox
                ...
                heButtonText=""
                enButtonUrl="https://donate.mekoros.com/sustainers"
                heButtonUrl="https://donate.mekoros.com/sustainershe"
                borderColor="#97B386"
            />,
            <FeatureBox
                enTitle="Sponsor a Day of Learning"
                heTitle=""
                enText="Fuel a day of study on Mekoros by celebrating a special occasion, commemorating a yahrzeit, or honoring a legacy — with a gift of $360 or more."
                heText=""
                enButtonText="Sponsor a Day of Learning"
                heButtonText=""
                enButtonUrl="https://donate.mekoros.com/sponsor"
                heButtonUrl="https://donate.mekoros.com/sponsorhe"
                borderColor="#4B71B7"
            />,
            <FeatureBox
                enTitle="Join a Giving Circle"
                heTitle=""
                enText="Become a lead supporter of Mekoros and ensure a vibrant future for the Jewish textual tradition."
                heText=""
                enButtonText="Join Now or Learn More"
                heButtonText=""
                enButtonUrl="https://donate.mekoros.com/campaign/giving-circles/c557214"
                heButtonUrl=""
                borderColor="#7C416F"
            />
          ...
          <ResponsiveNBox
            ...
            content={[
                <HeaderWithColorAccentBlockAndText
                    ...
                    heTitle=""
                    enText="<p>Make a donation by <strong>credit card, PayPal, GooglePay, ApplePay, Venmo, or bank transfer</strong> on our <a href='http://donate.mekoros.com/'>main donation page</a>.</p>"
                    heText=""
                    colorBar="#AB4E66"
                />,
                <HeaderWithColorAccentBlockAndText
                    ...
                    heTitle=""
                    enText="<p><strong>Personal checks</strong> should be made payable to “Mekoros” and mailed to:</p>
                            <p>Mekoros<br/>
                ...
                <HeaderWithColorAccentBlockAndText
                    ...
                    heTitle=""
                    enText="<p>Mekoros accepts donations from donor-advised funds; our <strong>EIN is 46-4406454</strong>. If you need additional information to make a DAF donation, please contact Caitlyn Cushing, Development Operations Associate, at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>.</p>"
                    heText=""
                    colorBar="#CCB479"
                />,
                <HeaderWithColorAccentBlockAndText
                    ...
                    heTitle=""
                    enText="<p>Mekoros also accepts donations via <strong>wire transfer</strong>, <strong>stock</strong>, and <strong>Cryptocurrency</strong>. For more information, please email Caitlyn Cushing, Development Operations Associate, at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>. (For wire transfers, you can also <a href='https://mekoros.formstack.com/forms/wire_request'>click here</a> to get our account information)."
                    heText=""
                    colorBar="#97B386"
                />
    ...
    <div className="staticPageBlockInner">
        ...
        <h2 className="serif">
            <span className="int-en">Your Gift to Mekoros</span>
        </h2>
        <Accordian
            enTitle="Can I make my gift in honor or memory of someone?"
            heTitle=""
            enText="<p>Yes! If you’re donating online, check the box for “Dedicate my donation <strong>in honor or in memory</strong> of someone” right after entering your donation amount. Then enter your desired tribute information and our donation processing platform will send your message to the recipient. If you have questions about this process, please email <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a></p>"
            heText=""
            colorBar="#B8D4D3"
        />

        <Accordian
            enTitle="Where does my gift go? How does Mekoros use the donations it receives?"
            heTitle=""
            enText="<p>Generally, gifts made to Mekoros are considered “unrestricted,” meaning that our staff allocates funds where they’re needed most. This includes everything from the text and learning you see on your screen to the technology support that keeps us online to the time and energy of the Mekoros team.</p>
                    <p><a href='https://www.guidestar.org/profile/46-4406454'>Mekoros has a Platinum rating on GuideStar</a> and we’re devoted to making sure we’re transparent and open with our donors. For a closer look at our financials, <a target='_blank' href='/static/files/Mekoros_2022_990_Public.pdf'>download the most recent Mekoros 990</a>.</p>"
            heText=""
            colorBar="#B8D4D3"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Our online giving page does not support restricted gifts. You can sponsor a day of learning <a href='https://donate.mekoros.com/sponsor'>here</a>. If you would like to sponsor a text or support a specific Mekoros program, please email Samantha Shokin, Grant Writer and Development Associate, at <a href='mailto:samantha@mekoros.com'>samantha@mekoros.com</a> for more information.</p>"
            heText=""
            colorBar="#B8D4D3"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>To learn more about available sponsorship dates and texts on Mekoros, send an email to Samantha Shokin, Grant Writer and Development Associate, at <a href='mailto:samantha@mekoros.com'>samantha@mekoros.com</a>, with “Sponsorship” in your subject line. We’ll aim to get back to you within two business days.</p>
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Mekoros is a registered 501(c)(3) in the United States, and all donations are fully tax-deductible under the extent of the law. We are not able to issue tax receipts to donors outside the United States.</p>"
            heText=""
            colorBar="#7F85A9"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>At this time, Mekoros only meets eligibility requirements for tax-exempt status in the United States.</p>"
            heText=""
            colorBar="#7F85A9"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Yes! Donors outside of the USA may make a gift online  – via credit card, PayPal, GooglePay, ApplePay, Venmo, and bank transfer – <a href='https://donate.mekoros.com/'>on this page</a> On this page you can modify your currency. You can also <a href='https://mekoros.formstack.com/forms/wire_request'>make a wire transfer</a>.</p>"
            heText=""
            colorBar="#7F85A9"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Donations from these types of institutions can be made through any of the payment methods listed in the Ways to Give section above. If you are donating from a foundation, federation, or donor-advised fund, please include any relevant gift acknowledgment information or preferences along with your gift. <strong>Mekoros's EIN is 46-4406454</strong>.</p>
                    <p>If you are sending your donation by mail, please include this information in a cover letter accompanying your check; if you are donating through a wire transfer or other electronic method, please send an email with this information to <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>. This ensures we have all the necessary information to send your gift acknowledgment and tax receipt.</p>"
            heText=""
            colorBar="#7F85A9"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Typically, matching gifts are directly acknowledged through the third-party processor. If you would like to request a thank you letter from the Mekoros team for the individual or organization matching your gift, please send us an email at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>. </p>"
            heText=""
            colorBar="#7F85A9"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>To cancel and/or request a refund for a donation, please follow the link in your email confirmation to view your online Classy (Mekoros's donation processor) profile where you can manually update or cancel your monthly gift. In addition, you can email Caitlyn Cushing, Development Operations Associate <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>, for support with this process.</p>"
            heText=""
            colorBar="#5A99B7"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>If you’re looking for a missing e-receipt, we first recommend checking your spam folder for any emails received from info@mekoros-inc.classy-mail.org. If you’re unable to find your gift receipt or you need a new copy of a mailed gift receipt, please email us at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>. </p>"
            heText=""
            colorBar="#5A99B7"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>We’re sorry to see you go! To cancel your sustaining donation, please follow the link in your email confirmation to view your online Classy (Mekoros's donation processor) profile where you can manually update or cancel your monthly gift. In addition, you can email Caitlyn Cushing, Development Operations Associate at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>, or by phone at <a href='tel:+13477730077'>(347) 773-0077</a></p>"
            heText=""
            colorBar="#5A99B7"
        />
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>To change the amount of or credit card information associated with your monthly donation, please follow the link in your email confirmation to your Classy (Mekoros's donation processor) profile. On your profile, you can edit this information. You can also contact Caitlyn Cushing, Development Operations Associate, at <a href='mailto:donate@mekoros.com'>donate@mekoros.com</a>, for assistance with this process."
            heText=""
            colorBar="#5A99B7"
        />
    ...
    <div className="staticPageCallToActionFooter">
      <div className="staticPageBlockInner flexContainer light">
          <div className="msgToSupporters">
            <h2 className="serif">
            Mekoros takes pride in its financial stewardship as a fully transparent, 501(c)(3) charitable organization. Mekoros’s EIN is 46-4406454.
            </h2>
          ...
          <ResponsiveNBox
            ...
            content={[
                <div className="finStewardBox">
                    ...
                    <p>Mekoros is proud to have received a Platinum Seal of Transparency from Guidestar, which indicates that we have proven a commitment to sharing our goals, strategies, and key metrics towards achieving our mission and vision.</p>
                    <SimpleButton
                        white={true}
                        rounded={true}
                        tall={false}
                ...
                <div className="finStewardBox">
                    <h2 className="serif">Mekoros’s 990 </h2>
                    ...
                    <SimpleButton
                        ...
                        tall={false}
                        newTab={true}
                        href="/static/files/Mekoros_2022_990_Public.pdf"
                        he_href=""
                        he=""
                        en="See Here"
                    />
  ...
  <StaticPage optionalClass="donate wordbyword">
    ...
    <div className="staticPageBlockInner">
        ...
        <Accordian
            ...
            heTitle=""
            enText="<p>Please email Rachel Buckman at <a href='mailto:rachel@mekoros.com'>rachel@mekoros.com</a></p>"
            heText=""
            colorBar="#B8D4D3"
        />
    ...
    <CallToActionFooterWithButton
        href="https://mekoros.typeform.com/to/wJXgn9jL"
        he_href=""
...
const PoweredByPage = () => (
    <StaticPage optionalClass="englishOnly">
        <Header
            enTitle="Powered by Mekoros"
            enText="Did you know that Mekoros’s open data and API can be used by anyone to create new technological solutions for learning Torah? You can find it all for free in the Mekoros Developer Portal!"
            heTitle="Powered by Mekoros"
            heText="Did you know that Mekoros’s open data and API can be used by anyone to create new technological solutions for learning Torah? You can find it all for free in the Mekoros Developer Portal!"
            enActionURL="https://developers.mekoros.com/"
            enActionText="Create Something New"
            heActionURL="https://developers.mekoros.com/"
        ...
        <GreyBox light={true}>
            <H2Block en="Projects Powered by Mekoros" he="Projects Powered by Mekoros"/>
        </GreyBox>
        <Feature
            enTitle="AlHaTorah"
            enText="AlHaTorah is a website with a broad range of tools for studying Tanakh, including study guides broken down by parashah, biblical art, and interactive modules. Among the available sources, AlHaTorah makes use of biblical commentaries from Mekoros’s library."
            ...
            heText="AlHaTorah is a website with a broad range of tools for studying Tanakh, including study guides broken down by parashah, biblical art, and interactive modules. Among the available sources, AlHaTorah makes use of biblical commentaries from Mekoros’s library."
            heTitle="AlHaTorah"
        ...
        <Feature
            enTitle="AllDaf"
            enText="This app for learning Daf Yomi from the Orthodox Union provides users with personalized feeds that adapt to learners’ interests, supporting study of the Daf in a user-friendly and approachable format. The English text on AllDaf is sourced from Mekoros."
            enImg="/static/img/powered-by-landing-page/alldaf.org_.png"
            enImgAlt="Screenshot of AllDaf"
            borderColor={palette.colors.yellow}
            link="https://alldaf.org/"
            heTitle="AllDaf"
            heText="This app for learning Daf Yomi from the Orthodox Union provides users with personalized feeds that adapt to learners’ interests, supporting study of the Daf in a user-friendly and approachable format. The English text on AllDaf is sourced from Mekoros."
            heImg="/static/img/powered-by-landing-page/alldaf.org_.png"
            heImgAlt="Screenshot of AllDaf"
        />
        <Feature
            enTitle="Hadran"
            enText="Founded in 2018 by a group of women studying Talmud together, Hadran aims to make the study of Talmud more accessible to Jewish women at all levels of learning. Among the resources they provide are guides to learning Daf Yomi, and these lessons use texts from Mekoros."
            ...
            heTitle="Hadran"
            heText="Founded in 2018 by a group of women studying Talmud together, Hadran aims to make the study of Talmud more accessible to Jewish women at all levels of learning. Among the resources they provide are guides to learning Daf Yomi, and these lessons use texts from Mekoros."
            heImg="/static/img/powered-by-landing-page/hadran.org.il_daf_yevamot-63_.png"
            heImgAlt="Screenshot of Hadran"
        />
        <Feature
            enTitle="Dicta"
            enText="Dicta is a nonprofit research organization based in Israel that applies cutting-edge machine learning and natural language processing (the ability of a computer program to understand human language as it is spoken and written) to the analysis of Hebrew texts. Mekoros and Dicta often collaborate, sharing texts and splitting the costs of shared projects. Dicta offers a broad range of tools for free use by anyone, including the ability to add nikud (vocalization) to text as you type, intuitive Talmud and Bible search, and more."
        ...
        <GreyBox>
            ...
            <EnBlock padded={true}>
                <p>Have you used Mekoros’s data to build an app, visualization, website, or other digital tool? Tell us about it! We’d love to see your project. You can also reach out to us with your questions about our open source data and API by writing to us at <a href="mailto:developers@mekoros.com">developers@mekoros.com</a>.</p>
            </EnBlock>
            <HeBlock padded={true}>
                <p>Have you used Mekoros’s data to build an app, visualization, website, or other digital tool? Tell us about it! We’d love to see your project. You can also reach out to us with your questions about our open source data and API by writing to us at <a href="mailto:developers@mekoros.com">developers@mekoros.com</a>.</p>
            </HeBlock>
...
const PBSC2021LandingPage = () => (
    <StaticPage>
        <Header
            enTitle="Powered by Mekoros Contest 2021"
            enText="Explore the Projects"
            enImg="/static/img/pbsc-2020-landing-page/codemockup3.png"
            enImgAlt=""
        ...
        <GreyBox>
            ...
            <EnBlock padded={true}>
                <p>In an effort to seed the digital future of Jewish texts, the Powered by Mekoros Contest was launched in July 2020 — inviting the global Mekoros community to make use of our free and open digital dataset of Jewish texts, translations, and interconnections. Over the years, dozens of third parties have created apps, visualizations, and conducted research using our data or API, and we wanted to see what else our community could dream up. The second annual Powered by Mekoros Contest saw tremendous enthusiasm and welcomed many high quality submissions from Mekoros users around the world. <strong>Keep reading to learn more about the two winners and some innovative honorable mentions.</strong></p>
            </EnBlock>
            <HeBlock padded={true}>
        ...
        <Feature
            enTitle="Mekoros Chavrusa"
            enText="Gershon Binder<br/><br/>Mekoros Chavrusa is designed to increase accessibility by introducing a text-to-speech feature on Mekoros. Most text-to-speech options struggle with Hebrew; Mekoros Chavrusa is a solution for people who use screen readers, are unfamiliar with reading Hebrew, or just prefer hearing texts read aloud.  It also allows for customized voices with different accents including Chassidish, Litvish, and Israeli."
            enImg="/static/img/pbsc-2021-landing-page/mekoroschavrusa.png"
            enImgAlt="Screenshot of Mekoros Chavrusa"
            ...
            heImg="/static/img/pbsc-2021-landing-page/mekoroschavrusa.png"
            heImgAlt="Screenshot of Mekoros Chavrusa"
            borderColor={palette.colors.yellow}
        ...
        <GreyBox>
            ...
            <Section noPadding={true}>
                <UserQuote
                    ...
                    enName="Lev Israel, Chief Data Officer at Mekoros"
        ...
        <Feature
            ...
            enText="By Valerie Monaco<br><br>The Torah Chanting Source Sheet Generator takes a range of Torah verses and provides a generated Mekoros sheet loaded with features for people learning how to chant, including trope identification and highlighting, trope cantillation tunes, and full verse chanting audio files."
        ...
        <ButtonRow white={true} enTitle="Explore the 2021 projects" heTitle="גלו את מיזמי 2021">
            { [
                ...
                ["Mekoros Space: (Topic Museum + Text Mania)", "מרחב ספריא (מוזיאון נושאי + טָרֶפֶת טקסט)", "https://mekoros-space.web.app/"],
                ...
                ["mekoros-connections", "קשרי ספריא", "https://charlesloder.github.io/mekoros-connections"],
                ["SefariAcrostic", "ספריאקרוסטיכון", "https://20gordone.github.io/MekorosContest"],
...
const SubscribeButton = ({enAction, heAction, heLists, enLists, redirectURL}) => {
  ...
  const handleClick = () => {
      if (Mekoros.util.isValidEmailAddress(email)) {
          setMessage("Subscribing...");
          setMessageStyle("italics");
          const lists = Mekoros.interfaceLang == "hebrew" ? heLists : enLists
...
const HeaderForEducatorsPage = () => {
  var enTitle="Teach with Mekoros"
  var enText="Discover the power of digital texts and tools in your classroom. Explore Mekoros’s many resources to enrich teaching and learning in your community."
...
const HeaderForRabbisPage = () => {
  var enTitle="Mekoros for Rabbis"
  var enText="Discover the power of digital texts and tools to fuel your rabbinate. Explore Mekoros’s many resources to enrich learning and teaching in your community."
...
const HeaderForDonatePage = () => {
  ...
  var enText="When you give to Mekoros, you’re powering a living library of more than 3,000 years of Jewish texts. Donate today and support the future of Jewish learning, innovation, and conversation."
  var heText="גלו כיצד להעשיר את הלמידה וההוראה באמצעות מאגר מקורות דיגיטלי. באתר אפשרויות רבות ללומדים:  תוכלו למצוא מקורות, להיפגש עם מגוון של חומרי הוראה ולחזק את התלמידים שלכם כלומדים עצמאיים."
  var heTitle="מלמדים עם ספריא"
...
const ParashaSponsorship = ({title, sponsorNames, message, link}) => {
    if (!sponsorNames) {
        return <div className="parashaSponsorship">
            ...
            <div className="parashaSponsorNames"><a target="_blank" href='mailto:hannah@mekoros.com?subject=Ramban Sponsorship'><b><i>Available for Sponsorship</i></b></a></div>
        </div>
    }
    else {
        return <div className="parashaSponsorship">
...
const byLastName = () => {
    const locale = Mekoros.interfaceLang === "hebrew" ? "he" : "en";
    return (a, b) => {
    ...
    const loadTeamMembers = async () => {
        if (typeof STRAPI_INSTANCE !== "undefined" && STRAPI_INSTANCE) {
            try {
                ...
                setError("Error: Mekoros's CMS cannot be reached");
            }
        } else {
            setError("Error: Mekoros's CMS cannot be reached");
        }
...
// Show a different header with a description of Mekoros for the page in the case that there are jobs available
const JobsPageHeader = ({ jobsAreAvailable }) => {
    return (
        <>
            <header>
                <h1 className="mobileAboutHeader">
                    <span className="int-en">Jobs at Mekoros</span>
                    <span className="int-he">משרות פנויות בספריא</span>
                </h1>
                {jobsAreAvailable ? (
                    <>
                        <h2>
                            <span className="int-en">About Mekoros</span>
                            <span className="int-he">אודות ספריא</span>
                        </h2>
                        <p>
                            <span className="int-en">
                                Mekoros is a nonprofit organization dedicated to creating the
...
const NoJobsNotice = () => {
    return (
        <div className="section nothing">
            <p>
                <span className="int-en">
                    Mekoros does not currently have any open positions.
                    Please follow us on <a target="_blank" href="http://www.facebook.com/mekoros.com" >Facebook</a>
                    to hear about our next openings.
                </span>
                <span className="int-he">
                    ספריא איננה מחפשת כעת עובדים חדשים.
                    עקבו אחרינו ב<a target="_blank" href="http://www.facebook.com/mekoros.com" >פייסבוק</a>&nbsp;
