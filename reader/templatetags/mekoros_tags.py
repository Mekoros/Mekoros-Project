# -*- coding: utf-8 -*-
"""
Custom Mekoros Tags for Django Templates
"""
import json
import re
...
from mekoros.model.user_profile import user_link as ulink, user_name as uname, public_user_data
from mekoros.model.text import Version
from mekoros.model.collection import Collection
from mekoros.utils.util import strip_tags as strip_tags_func
from mekoros.utils.hebrew import hebrew_plural, hebrew_term, hebrew_parasha_name
from mekoros.utils.hebrew import hebrew_term as translate_hebrew_term

import mekoros.model.text
import mekoros.model as m
from mekoros.model.text import library, AbstractIndex
...
def absolute_link(value):
	...
	<a href='/Job.3.4'>Job 3:4</a> --> <a href='http://www.mekoros.com/Job.3.4'>Job 3:4</a>
	"""
