...
The text of different editions of the Mishnah can have significant differences. In addition, the Wikisource
 edition of the Mishnah originally hosted on Mekoros seems to be very inaccurate, and was ultimately replaced
...
class TestSuite:
    ...
    def write_results(self, finished_tests, reference):
        ...
        if self.html:
            ...
            self.output.write('<a href="http://draft.mekoros.com/{}">'.format(reference.replace(' ', '_')))
    ...
    for book in books:
        ...
        for ref in Ref(book).all_subrefs():
            ...
            if result.passed:
                ...
                outfile.write('{},'.format(' '.join(str(index) for index in result.diff)))
